...
const Profile = () => {
    ...
    const sections = [
        ...
        { id: 3, title: 'Subscription', status: 'Dromoney Pro • Active', action: 'Manage' },
        ...
        { id: 6, title: 'Terms & Conditions', status: 'Legal and privacy policy', type: 'link' },
    ];

    return (
        <div className="flex flex-col gap-6 p-5 bg-[#F8FAFC] animate-in fade-in duration-700 pb-20 min-h-screen">
            ...
            {/* --- Profile Header (Image 1 Content Style) --- */}
            <div className="flex flex-col items-center mt-6 mb-4 text-center">
                <label className="relative cursor-pointer group mb-4">
                    ...
                    <div className="relative w-24 h-24 bg-white rounded-full flex items-center justify-center ring-4 ring-white shadow-xl shadow-slate-200/50 overflow-hidden">
                        {profileImg ? (
                ...
                <div className="bg-slate-900/5 px-3 py-1 rounded-full mt-2 inline-block">
                    <p className="text-[10px] font-black text-slate-400 capitalize tracking-widest leading-none">{id}</p>
                </div>
            </div>
            ...
            <div className="mt-4 flex flex-col items-center">
                ...
                <div className="mt-10 mb-6 text-center bg-slate-100/50 px-5 py-2 rounded-full border border-slate-100 inline-block">
                    <p className="text-[9px] font-black text-slate-300 uppercase tracking-[0.4em]">Build Version 1.0.0 (Beta)</p>
                </div>
                <div className="w-16 h-1 bg-slate-200/50 rounded-full mt-4"></div>
            </div>
        </div>
    );
};
